  ...
  <div id="app">
      <div class="privacy-container">
        ...
        <p>
          ...
          on your device. Additionally, as you browse the Site, we collect information about the individual 
          web pages or products that you view, what websites or search terms referred you to the Site, and 
        ...
        <p>
          Additionally when you submit a request form or attempt to submit a request form through the Site, we 
          collect certain information from you, including your name, phone number, email address, and other
          information.  We refer to this information as “Order Information.”
        </p>
        <p>
        ...
        <p>
          ...
          as described above.  For exaple we use Google Analytics to help us understand how our customers 
        ...
        <p>
          As described above, we may use your Personal Information to provide you with targeted advertisements or 
          marketing communications we believe may be of interest to you.  For more information about how targeted 
          advertising works, you can visit the Network Advertising Initiative’s (“NAI”) educational 
        ...
        <p>
          <ul>
            <li>
              <a href="https://www.facebook.com/settings/?tab=ads " target="_blank"> FACEBOOK  </a>
            </li>
            <li>
              <a href="https://www.google.com/settings/ads/anonymous " target="_blank"> GOOGLE  </a>
            </li>
            <li>
              <a href="https://advertise.bingads.microsoft.com/en-us/resources/policies/personalized-ads " target="_blank"> BING </a>
            </li> 
          </ul>
         </p>
        <p>
        ...
        <p>
          ...
          to make a complaint, please contact us by e-mail at bluebirdflowersllc@gmail.com or by mail using
          the details provided below:
        </p>
        <p>
        Bluebird Flowers
        1203 Wilamette Street, Eugene, OR, 97401, United States
        </p>
    </div>
  </div>
</template>
