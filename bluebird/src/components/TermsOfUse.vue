<template>
  <div class="terms-container">
    ...
    <p>
      This website is operated by Bluebird Flowers. Throughout the site, the terms “we”, “us” and “our” 
      refer to Bluebird Flowers. Bluebird Flowers offers this website, including all information, 
    ...
    <p>
      ...
      all the terms and conditions of this agreement, then you may not access the website or use any services. 
    ...
    <p>
      ...
      relied upon or used as the sole basis for making decisions without consulting primary, more accurate, 
    ...
    <p>
      ...
      site at any time, but we have no obligation to update any information on our site. You agree that 
    ...
    <p>
      ...
      may attempt to notify you by contacting the e-mail and/or billing address/phone number provided at 
      the time the order was made. We reserve the right to limit or prohibit orders that, in our sole judgment, 
    ...
    <p>
      ...
      of any kind, either express or implied, including all implied warranties or conditions of merchantability, 
      merchantable quality, fitness for a particular purpose, durability, title, and non-infringement.
    </p>
    <p>
      In no case shall Bluebird Flowers, our directors, officers, employees, affiliates, agents, contractors, 
      ...
      even if advised of their possibility. Because some states or jurisdictions do not allow the exclusion 
      or the limitation of liability for consequential or incidental damages, in such states or jurisdictions, 
    ...
    <p>
      You agree to indemnify, defend and hold harmless Bluebird Flowers and our parent, subsidiaries, 
    ...
    <p>
      ...
      and construed in accordance with the laws of 1203 Wilamette Street, Eugene, OR, 97401, United States.
    </p>
    <h3>
    ...
    <p>
      Questions about the Terms of Service should be sent to us at bluebirdflowersllc@gmail.com.
    </p>
    </div>
</template>
